            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Tambah Admin</button>   
                    </div>
                                     ...
                                     <form method="Post" action="{{route('Addadmin')}}" onsubmit="return validateForm()">
                                      @csrf
                                        <div class="form-group custom-form-group">
                                           ...
                                           <input type="text" class="form-control custom-input" id="username" placeholder="Masukkan Username Admin" name="username" required>
                                       </div>
                                       <div class="form-group custom-form-group">
                                           <label for="nik" class="custom-label">Password :</label>
                                           <input type="text" class="form-control custom-input" id="password" placeholder="Masukkan Password Admin" name="password" required>
                                       </div>
                                       <div class="form-group custom-form-group">
                                       ...
                                       <div class="form-group custom-form-group">
                                           ...
                                           <input type="text" class="form-control custom-input" id="nama" placeholder="Masukkan Nama Admin" name="nama" required>
                                       </div>
                                       <div class="form-group custom-form-group">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('Removeadmin') }}" data-id="{{ $a->id }}">
                                        @csrf
                                        @method('DELETE')
